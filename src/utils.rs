// utils.rs - Utility functions for RCraft
...
/// Parse a version string like "1.20.4" into (major, minor, patch)
...
/// Check if a version is at least Minecraft 1.8
...
/// Check if a version is at least Minecraft 1.14 (Fabric support)
...
/// Get total system RAM in MB (Linux only)
...
/// Determine if a library is allowed on the current OS
